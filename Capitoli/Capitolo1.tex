...
% da questa enorme mole di dati può rivelare pattern molto specifici ed utilizzabili in numerose attività per produrre vantaggi competitivi. Recenti sviluppi nell'ambito di svariate aree dell'informatica hanno portato negli ultimi anni alla creazione di sempre più nuove ed efficaci tecniche. 
\\\\
\color{red}
...
Quando si confrontano i task di Web Mining con i più tradizionali task di Data Mining,
\color{red}
SISTEMA
